...
public class UiTestUtilities {
	...
	// EmcMetalnxVersion.BUILD_NUMBER.equals("DEV");
	...
	// public static String IRODS_HOST = isDevEnv ? "icat.localdomain" :
	// "icat.prod.localdomain";
	...
	public static void login() {
		login(UiTestUtilities.testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY),
	...
	/*
	 * public void warning(CSSParseException e) { // no warning logs }
	 * 
	 * public void error(CSSParseException e) { // no error logs }
	 * 
	 * }
	 * 
	 * public static String getModifyGroupsPage(String gname) { return
	 ...
	 * 
	 *         public String getIrodsHost() { return IRODS_HOST; }
	 */
	/**
	 ...
	 * @return the zone
	 * 
	 *         public String getZone() { return IRODS_ZONE; }
	 */
